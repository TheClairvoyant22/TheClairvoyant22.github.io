...
$client = new apiClient();
  ...
  $client->setClientId('177931824425-k3q9a3hhj0us2blde9giuc4je862cgk8.apps.googleusercontent.com');
  $client->setClientSecret('jzH1OwjPMbkHf6-PVkhcFL21');
  $client->setRedirectUri('http://theclairvoyant22.github.io/example.php');
  $client->setDeveloperKey('AIzaSyA8Ohu4H73KDEMP1QnKyOyx347XzuFOFbQ');
...
- See more at: http://www.w3resource.com/API/google-plus/tutorial.php#sthash.7ePOuAgA.dpuf
